...
(function( Lifting, $, undefined ) {
	...
	Lifting.SetDefaults = function() {
		...
		Lifting.settings.setList.push({muscleGroup :"CHEST", liftName : "BENCH (INCLINE)", setNumber: 1, reps: 6, weight: 200});
		Lifting.settings.setList.push({muscleGroup :"CHEST", liftName : "BENCH (INCLINE)", setNumber: 2, reps: 6, weight: 220});
		Lifting.settings.setList.push({muscleGroup :"CHEST", liftName : "BENCH (INCLINE)", setNumber: 3, reps: 3, weight: 230});
		Lifting.settings.setList.push({muscleGroup :"CHEST", liftName : "DUMBBELL FLYS"});
		Lifting.settings.setList.push({muscleGroup :"CHEST", liftName : "DIPS"});
